<?php
function mtblko_load_widget() {
    register_widget( 'mtblko_widget' );
}
add_action( 'widgets_init', 'mtblko_load_widget' );

// Creating the widget
class mtblko_widget extends WP_Widget {
    function __construct() {
        parent::__construct('mtblko_widget',__('Metaboliko Social Icons', 'mtblko_widget_domain'),array( 'description' => __( 'Botones de redes sociales.', 'mtblko_widget_domain' ), ));
    }
...
public function form( $instance ) {
    if ( isset( $instance[ 'title' ] ) ) {
        ...
        $title = __( 'New title', 'mtblko_widget_domain' );
    }

    if ( isset( $instance[ 'mtblko_facebook' ] ) ) {
        $facebook = $instance[ 'mtblko_facebook' ];
    }else{
        $facebook = __( '#', 'mtblko_widget_domain' );
    }

    if ( isset( $instance[ 'mtblko_youtube' ] ) ) {
        $youtube = $instance[ 'mtblko_youtube' ];
    }else{
        $youtube = __( '#', 'mtblko_widget_domain' );
    }

    if ( isset( $instance[ 'mtblko_linkedin' ] ) ) {
        $linkedin = $instance[ 'mtblko_linkedin' ];
    }else{
        $linkedin = __( '#', 'mtblko_widget_domain' );
    }

    if ( isset( $instance[ 'mtblko_pinterest' ] ) ) {
        $pinterest = $instance[ 'mtblko_pinterest' ];
    }else{
        $pinterest = __( '#', 'mtblko_widget_domain' );
    }

    if ( isset( $instance[ 'mtblko_whatsapp' ] ) ) {
        $whatsapp = $instance[ 'mtblko_whatsapp' ];
    }else{
        $whatsapp = __( '#', 'mtblko_widget_domain' );
    }
    
    if ( isset( $instance[ 'mtblko_whatsapp_text' ] ) ) {
        $whatsapp_text = $instance[ 'mtblko_whatsapp_text' ];
    }else{
        $whatsapp_text = __( '#', 'mtblko_widget_domain' );
    }
    
    if ( isset( $instance[ 'mtblko_instagram' ] ) ) {
        $instagram = $instance[ 'mtblko_instagram' ];
    }else{
        $instagram = __( '#', 'mtblko_widget_domain' );
    }

    if ( isset( $instance[ 'mtblko_twitter' ] ) ) {
        $twitter = $instance[ 'mtblko_twitter' ];
    }else{
        $twitter = __( '#', 'mtblko_widget_domain' );
    }
// Widget admin form
?>
<p>
...
<ul>
    <li>
        <label
            for="<?php echo $this->get_field_id('mtblko_facebook');?>"><strong><?php _e( 'Facebook:' ); ?></strong></label>
        </br>
        <input type="text" id="<?php echo $this->get_field_id('mtblko_facebook');?>"
            name="<?php echo $this->get_field_name('mtblko_facebook');?>" value="<?php echo esc_attr( $facebook ); ?>">
        <hr>
    </li>
    <li>
        <label
            for="<?php echo $this->get_field_id('mtblko_linkedin');?>"><strong><?php _e( 'LinkedIn:' ); ?></strong></label></br>
        <input type="text" id="<?php echo $this->get_field_id('mtblko_linkedin');?>"
            name="<?php echo $this->get_field_name('mtblko_linkedin');?>" value="<?php echo esc_attr( $linkedin ); ?>">
        <hr>
    </li>
    <li>
        <label
            for="<?php echo $this->get_field_id('mtblko_instagram');?>"><strong><?php _e( 'Instagram:' ); ?></strong></label></br>
        <input type="text" id="<?php echo $this->get_field_id('mtblko_instagram');?>"
            name="<?php echo $this->get_field_name('mtblko_instagram');?>"
            value="<?php echo esc_attr( $instagram ); ?>">
        <hr>
    </li>
    <li>
        <label
            for="<?php echo $this->get_field_id('mtblko_twitter');?>"><strong><?php _e( 'Twitter:' ); ?></strong></label></br>
        <input type="text" id="<?php echo $this->get_field_id('mtblko_twitter');?>"
            name="<?php echo $this->get_field_name('mtblko_twitter');?>" value="<?php echo esc_attr( $twitter ); ?>">
        <hr>
    </li>
    <li>
        <label
            for="<?php echo $this->get_field_id('mtblko_youtube');?>"><strong><?php _e( 'YouTube:' ); ?></strong></label></br>
        <input type="text" id="<?php echo $this->get_field_id('mtblko_youtube');?>"
            name="<?php echo $this->get_field_name('mtblko_youtube');?>" value="<?php echo esc_attr( $youtube ); ?>">
        <hr>
    </li>
    <li>
        <label
            for="<?php echo $this->get_field_id('mtblko_pinterest');?>"><strong><?php _e( 'Pinterest:' ); ?></strong></label></br>
        <input type="text" id="<?php echo $this->get_field_id('mtblko_pinterest');?>"
            name="<?php echo $this->get_field_name('mtblko_pinterest');?>"
            value="<?php echo esc_attr( $pinterest ); ?>">
        <hr>
    </li>
    <li>
        <label
            for="<?php echo $this->get_field_id('mtblko_whatsapp');?>"><strong><?php _e( 'Whatsapp:' ); ?></strong></label></br>
        <input type="text" id="<?php echo $this->get_field_id('mtblko_whatsapp');?>"
            name="<?php echo $this->get_field_name('mtblko_whatsapp');?>" value="<?php echo esc_attr( $whatsapp ); ?>">
        <br>
        ...
        <br><br>
        <label
            for="<?php echo $this->get_field_id('mtblko_whatsapp_text');?>"><strong><?php _e( 'Mensaje predeterminado:' ); ?></strong></label>
        </br>
        <input type="text" id="<?php echo $this->get_field_id('mtblko_whatsapp_text');?>"
            name="<?php echo $this->get_field_name('mtblko_whatsapp_text');?>"
            value="<?php echo esc_attr( $whatsapp_text ); ?>">
        <hr>
